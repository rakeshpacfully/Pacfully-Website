...
export const INDUSTRIES = [
  { name: "Cosmetics", icon: "Sparkles", slug: "cosmetics", img: "https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=1200" },
  { name: "Perfume", icon: "SprayCan", slug: "perfume", img: "https://images.unsplash.com/photo-1541643600914-78b084683601?w=1200" },
  { name: "Jewelry", icon: "Gem", slug: "jewelry", img: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=1200" },
  { name: "Food & Sweets", icon: "Cookie", slug: "food-sweets", img: "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=1200" },
  { name: "Chocolate", icon: "Candy", slug: "chocolate", img: "https://images.unsplash.com/photo-1481391319762-47dff72954d9?w=1200" },
  { name: "Apparel", icon: "Shirt", slug: "fashion-apparel", img: "https://images.unsplash.com/photo-1595246007497-15e0ed4b8d96?w=1200" },
  { name: "Ecommerce", icon: "Package", slug: "ecommerce", img: "https://images.unsplash.com/photo-1575176647987-4c1a2e598950?w=1200" },
  { name: "Electronics", icon: "Cpu", slug: "electronics", img: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=1200" },
  { name: "Mobile Phones", icon: "Smartphone", slug: "electronics", img: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=1200" },
  { name: "Corporate Gifting", icon: "Gift", slug: "corporate-gifting", img: "https://images.unsplash.com/photo-1513885535751-8b9238bd345a?w=1200" },
];
...
export const SERVICES = [
  ...
  { slug: "labels", productSlug: "labels", title: "Product Labels", icon: "Tag", desc: "Pressure-sensitive, shrink-sleeve, foil and security labels with variable data printing.", img: "https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=1400" },
  ...
  { slug: "paper-bags", productSlug: "paper-bags", title: "Paper Bags", icon: "ShoppingBag", desc: "Sustainable paper bags with twisted, rope, ribbon and die-cut handles for retail and luxury.", img: "https://images.unsplash.com/photo-1595246007497-15e0ed4b8d96?w=1400" },
  ...
  { slug: "offset", productSlug: null, title: "Offset Printing", icon: "Printer", desc: "High-volume 5-color UV and conventional offset printing with razor-sharp registration.", img: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=1400" },
  ...
  { slug: "design", productSlug: null, title: "Packaging Design", icon: "Palette", desc: "Structural & graphic design, dielines, mockups, and material consultancy.", img: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=1400" },
];
...
export const SHOWCASE = [
  ...
  { title: "Apparel Box", category: "Apparel Packaging", img: "https://images.unsplash.com/photo-1595246007497-15e0ed4b8d96?w=900", h: "tall" },
...
export const PRODUCT_CATEGORIES = [
  ...
  },
  {
    ...
    hero: "https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=1600",
...
export const SUB_IMAGES = [
  ...
  "https://images.unsplash.com/photo-1595246007497-15e0ed4b8d96?w=800",
...
export const FINISHES = [
  { name: "Hot Foil Stamping", img: "https://images.unsplash.com/photo-1607344645866-009c320b63e0?w=900", desc: "Metallic gold, silver, copper and holographic foils for premium accents." },
  { name: "Embossing", img: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=900", desc: "Raised relief for logos and patterns — tactile luxury." },
  { name: "Debossing", img: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=900", desc: "Recessed impressions for a refined, minimal aesthetic." },
  { name: "Spot UV", img: "https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=900", desc: "High-gloss varnish over matte for dramatic contrast." },
  ...
  { name: "Ribbon Pulls", img: "https://images.unsplash.com/photo-1595246007497-15e0ed4b8d96?w=900", desc: "Satin or grosgrain pulls for drawer-style unboxing." },
];
...
export const INDUSTRIES_DETAIL = [
  {
    ...
    img: "https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=1600",
    uses: ["Skincare cartons","Perfume rigid boxes","Lipstick sleeves","Subscription kits"],
    desc: "Shelf-ready cartons and luxe rigid boxes engineered for cosmetic retail.",
    overview: "Premium packaging solutions designed for cosmetic and beauty brands. From luxury rigid boxes to high-quality printed monocartons and labels, we create packaging that enhances shelf appeal, protects products, and strengthens your brand identity across every category — from skincare and color cosmetics to subscription kits and limited editions.",
    solutions: ["rigid-boxes","fmcg-monocartons","labels","luxury-gift-boxes"],
    popularStyles: [
      { group: "Rigid Boxes", items: ["Magnetic Closure","Lift-off Lid","Shoulder Neck"] },
      { group: "Monocartons", items: ["Straight Tuck End","Reverse Tuck End","Window Cartons"] },
      { group: "Labels", items: ["Foil Labels","Transparent Labels","Pressure Sensitive"] },
    ],
    gallery: ["1583209814683-c023dd293cc6","1607344645866-009c320b63e0","1607082348824-0a96f2a4b9da","1513885535751-8b9238bd345a","1575176647987-4c1a2e598950","1611591437281-460bfbe1220a"],
    faqs: [
      { q: "Do you provide food-grade inks for lip & oral care?", a: "Yes — all lip, oral and child-facing packaging uses certified low-migration food-grade inks and coatings." },
      { q: "Can you print Pantone-matched skin tones for foundation cartons?", a: "Absolutely. Our 5-color UV offset with custom Pantone bases delivers ±2 ΔE accuracy across production runs." },
      { q: "What's the typical MOQ for beauty brands?", a: "100 units for rigid boxes, 500 units for monocartons, and 250 units for labels — perfect for pilot launches." },
    ],
  },
  {
    slug: "perfume",
    ...
    popularStyles: [
      ...
      { group: "Gift Sets", items: ["Drawer Gift Boxes","Book Style Gift Boxes","Hamper Gift Boxes"] },
      { group: "Finishing", items: ["Hot Foil + Emboss","Spot UV on Matte","Soft-Touch Lamination"] },
    ],
    gallery: ["1607082348824-0a96f2a4b9da","1583209814683-c023dd293cc6","1607344645866-009c320b63e0","1513885535751-8b9238bd345a","1611591437281-460bfbe1220a","1575176647987-4c1a2e598950"],
    faqs: [
      { q: "How do you protect glass flacons during shipping?", a: "We use die-cut EVA foam, moulded pulp or flocked rigid inserts engineered to your bottle's exact geometry." },
      { q: "Can you produce discovery / sample sets?", a: "Yes — our drawer and book-style rigid boxes are perfect for 5–10ml discovery sets with branded interior prints." },
      { q: "Do you handle export-grade packaging compliance?", a: "We comply with IATA dangerous-goods labelling and EU CLP packaging requirements for fragrance shipments." },
    ],
  },
  {
    slug: "jewelry",
    name: "Jewelry",
    img: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=1600",
    uses: ["Magnetic ring boxes","Velvet insert trays","Drawer necklace cases","Brand sleeves"],
    desc: "Heirloom-grade boxes with felt and velvet inserts.",
    overview: "Jewelry packaging built to safeguard heirlooms and elevate first impressions. From magnetic ring boxes with velvet inserts to drawer necklace cases and shoulder-neck pendant boxes, we deliver museum-grade tolerances, hand-finished interiors and bespoke brand sleeves that match the gravity of what's inside.",
    solutions: ["rigid-boxes","luxury-gift-boxes","paper-bags","labels"],
    popularStyles: [
      { group: "Rigid Boxes", items: ["Magnetic Ring Boxes","Drawer Necklace Cases","Hinged Lid"] },
      { group: "Inserts", items: ["Velvet Trays","Flocked Foam","Satin Lining"] },
      { group: "Finishing", items: ["Hot Foil Monogram","Embossed Logo","Edge Foiling"] },
    ],
    gallery: ["1611591437281-460bfbe1220a","1607082348824-0a96f2a4b9da","1513885535751-8b9238bd345a","1607344645866-009c320b63e0","1583209814683-c023dd293cc6","1575176647987-4c1a2e598950"],
    faqs: [
      { q: "Can you supply velvet and satin inserts?", a: "Yes — we manufacture velvet, satin, flocked and EVA inserts in-house with bespoke colours and cavity engineering." },
      { q: "Do you offer hot foil monograms?", a: "Hot foil monograms in gold, silver, rose-gold and holographic — combined with blind embossing for that hallmark luxury touch." },
    ],
  },
  {
    slug: "food-sweets",
    name: "Food & Sweets",
    img: "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=1600",
    uses: ["Mithai boxes","Bakery cartons","Hamper boxes","Window cartons"],
    desc: "Food-safe inks and barrier coatings for FSSAI compliance.",
    overview: "Food and sweets packaging that combines hygiene, shelf appeal and structural integrity. Our mithai, bakery and gourmet cartons use FSSAI-compliant food-grade inks, barrier laminations and tamper-evident closures — engineered for festive gifting, retail shelves and last-mile delivery.",
    solutions: ["fmcg-monocartons","rigid-boxes","luxury-gift-boxes","paper-bags"],
    popularStyles: [
      { group: "Monocartons", items: ["Window Cartons","Sleeve Cartons","Pillow Boxes"] },
      { group: "Rigid Boxes", items: ["Magnetic Hamper","Drawer Sweet Box","Tray & Sleeve"] },
      { group: "Compliance", items: ["Food-Grade Inks","Barrier Coating","Tamper Evident"] },
    ],
    gallery: ["1558961363-fa8fdf82db35","1607344645866-009c320b63e0","1513885535751-8b9238bd345a","1607082348824-0a96f2a4b9da","1583209814683-c023dd293cc6","1611591437281-460bfbe1220a"],
    faqs: [
      { q: "Are your inks FSSAI compliant?", a: "Yes — we use low-migration, food-grade inks and aqueous coatings approved for direct food contact zones." },
      { q: "Can you do festive hamper boxes for Diwali / Eid?", a: "Absolutely — magnetic hamper boxes, drawer sets and tray-sleeve hampers in custom shapes and finishes are our specialty." },
    ],
  },
  {
    slug: "chocolate",
    name: "Chocolate",
    img: "https://images.unsplash.com/photo-1481391319762-47dff72954d9?w=1600",
    uses: ["Bar sleeves","Truffle rigid boxes","Pralines tray boxes","Gifting hampers"],
    desc: "Premium foiling, embossing and tray-sleeve constructions.",
    overview: "Chocolate packaging that feels as crafted as what's inside. From single-bar sleeves to truffle tray-and-sleeve rigid boxes, we deliver food-grade structural design, hot-foil finishing and bespoke inserts that protect couverture, retain aroma and command shelf attention.",
    solutions: ["rigid-boxes","fmcg-monocartons","luxury-gift-boxes","labels"],
    popularStyles: [
      { group: "Rigid Boxes", items: ["Tray & Sleeve","Magnetic Closure","Drawer Style"] },
      { group: "Monocartons", items: ["Bar Sleeves","Pillow Boxes","Window Cartons"] },
      { group: "Finishing", items: ["Hot Foil","Embossing","Soft-Touch Matte"] },
    ],
    gallery: ["1481391319762-47dff72954d9","1607344645866-009c320b63e0","1513885535751-8b9238bd345a","1607082348824-0a96f2a4b9da","1558961363-fa8fdf82db35","1583209814683-c023dd293cc6"],
    faqs: [
      { q: "Can the packaging preserve chocolate aroma?", a: "Yes — we apply low-VOC food-safe coatings and recommend foil-laminated inner sleeves to retain aroma and prevent migration." },
      { q: "Do you make couverture truffle trays?", a: "Custom moulded pulp trays, EVA inserts and corrugated cavity boards for 4–24 piece truffle arrangements." },
    ],
  },
  {
    slug: "electronics",
    ...
    uses: ["Device rigid boxes","Accessory cartons","Protective inserts","Tech subscription"],
    desc: "Apple-grade tolerances with EVA and pulp inserts.",
    overview: "Electronics packaging engineered to Apple-grade tolerances. From magnetic device rigid boxes with thermoformed EVA cradles to accessory monocartons and protective pulp inserts, we deliver unboxing experiences that signal premium engineering — while protecting fragile components through last-mile logistics.",
    solutions: ["rigid-boxes","fmcg-monocartons","ecommerce-packaging","corrugated-boxes"],
    popularStyles: [
      { group: "Rigid Boxes", items: ["Magnetic Device Box","Lift-off Lid","Two-piece Telescope"] },
      { group: "Inserts", items: ["EVA Foam","Moulded Pulp","Honeycomb Paper"] },
      { group: "Protection", items: ["Anti-Static Lining","ESD-safe Inserts","Reinforced Corners"] },
    ],
    gallery: ["1607082348824-0a96f2a4b9da","1607344645866-009c320b63e0","1575176647987-4c1a2e598950","1513885535751-8b9238bd345a","1595246007497-15e0ed4b8d96","1583209814683-c023dd293cc6"],
    faqs: [
      { q: "Do you offer anti-static / ESD-safe packaging?", a: "Yes — for sensitive electronics we offer ESD-rated conductive inserts and anti-static liners." },
      { q: "Can you handle Apple-like soft-open friction-fit lids?", a: "Our friction-fit telescope boxes deliver the same controlled-resistance opening with calibrated air-release channels." },
    ],
  },
  {
    slug: "ecommerce",
    name: "Ecommerce",
    img: "https://images.unsplash.com/photo-1575176647987-4c1a2e598950?w=1600",
    uses: ["Mailer boxes","Book wraps","Subscription boxes","Return packaging"],
    desc: "Tear-strip, double-glue and self-locking constructions for last-mile.",
    overview: "Ecommerce packaging engineered for the entire shipping journey. From self-locking mailer boxes with tear strips and return adhesive to book wraps, subscription kits and protective inserts — every Pacfully D2C solution balances structural strength, brand storytelling and unboxing emotion at scale.",
    solutions: ["ecommerce-packaging","corrugated-boxes","paper-bags","labels"],
    popularStyles: [
      { group: "Mailers", items: ["Roll End Tuck Top","Self-Locking Mailers","Book Wrap Mailers"] },
      { group: "Inserts", items: ["Honeycomb Paper","Pulp Trays","Corrugated Dividers"] },
      { group: "Branding", items: ["Inside Print","Branded Tape","Tissue & Sticker Kit"] },
    ],
    gallery: ["1575176647987-4c1a2e598950","1595246007497-15e0ed4b8d96","1607082348824-0a96f2a4b9da","1607344645866-009c320b63e0","1513885535751-8b9238bd345a","1583209814683-c023dd293cc6"],
    faqs: [
      { q: "Do you support return packaging with second adhesive strips?", a: "Yes — our mailer boxes include a primary tear strip and secondary return-glue strip for easy two-way shipping." },
      { q: "What's your minimum for branded mailer boxes?", a: "Branded printed mailers from 500 units. Plain kraft from 200." },
    ],
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1575176647987-4c1a2e598950?w=1600",
    uses: ["Garment boxes","Shoe boxes","Tissue & ribbon","Carry bags"],
    desc: "Premium garment boxes with custom tissue and ribbon.",
    overview: "Fashion packaging that turns retail into ritual. From garment rigid boxes with satin ribbons to luxury shoe boxes, branded tissue, sticker seals and laminated carry bags — Pacfully delivers a coherent unboxing system for boutique, D2C and luxury fashion houses.",
    solutions: ["rigid-boxes","paper-bags","luxury-gift-boxes","ecommerce-packaging"],
    popularStyles: [
      { group: "Rigid Boxes", items: ["Lift-off Lid Garment Box","Magnetic Apparel Box","Shoulder Neck"] },
      { group: "Paper Bags", items: ["Twisted Handle","Ribbon Handle","Luxury Laminated"] },
      { group: "Add-ons", items: ["Branded Tissue","Custom Ribbon","Sticker Seals"] },
    ],
    gallery: ["1575176647987-4c1a2e598950","1607344645866-009c320b63e0","1513885535751-8b9238bd345a","1583209814683-c023dd293cc6","1607082348824-0a96f2a4b9da","1611591437281-460bfbe1220a"],
    faqs: [
      { q: "Can you supply branded tissue paper and ribbon?", a: "Yes — branded tissue, satin / grosgrain ribbon and custom sticker seals to complete the unboxing system." },
      { q: "Do you make shoe boxes with magnetic closures?", a: "Magnetic-flap shoe boxes in any size with custom interior prints and dust-bag pockets." },
    ],
  },
  {
    slug: "corporate-gifting",
    name: "Corporate Gifting",
    img: "https://images.unsplash.com/photo-1513885535751-8b9238bd345a?w=1600",
    uses: ["Hamper boxes","Diwali sets","Welcome kits","Joining hampers"],
    desc: "End-to-end hamper design, sourcing and kitting.",
    overview: "Corporate gifting packaging built for moments that matter — Diwali, joining kits, milestone gifts and client appreciation. We design rigid hamper boxes, drawer gift sets and laminated paper bags, complete with kitting, custom inserts and dispatch-ready labelling.",
    solutions: ["luxury-gift-boxes","rigid-boxes","paper-bags","fmcg-monocartons"],
    popularStyles: [
      { group: "Gift Boxes", items: ["Magnetic Hamper","Drawer Gift Set","Lift-off Lid"] },
      { group: "Carriers", items: ["Luxury Paper Bag","Ribbon Handle","Custom Carrier"] },
      { group: "Finishing", items: ["Hot Foil Logo","Velvet Lining","Custom Inserts"] },
    ],
    gallery: ["1513885535751-8b9238bd345a","1607344645866-009c320b63e0","1607082348824-0a96f2a4b9da","1611591437281-460bfbe1220a","1583209814683-c023dd293cc6","1575176647987-4c1a2e598950"],
    faqs: [
      { q: "Do you handle kitting and assembly?", a: "Yes — we kit, wrap, label and dispatch direct to recipients across India and selected international locations." },
      { q: "Can you customise per employee with names?", a: "Variable-data digital printing lets us personalise each box with names, designations or messages at no extra plate cost." },
    ],
  },
];

export const INDUSTRY_FINISHES = [
  { name: "Gold Foiling", img: "https://images.unsplash.com/photo-1513885535751-8b9238bd345a?w=900", desc: "24-karat tone hot foil for monograms and logos." },
  { name: "Silver Foiling", img: "https://images.unsplash.com/photo-1607344645866-009c320b63e0?w=900", desc: "Cool metallic silver for modern minimal accents." },
  { name: "Spot UV", img: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=900", desc: "High-gloss varnish over matte for dramatic contrast." },
  { name: "Embossing", img: "https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=900", desc: "Raised relief for tactile, sculpted detailing." },
  { name: "Debossing", img: "https://images.unsplash.com/photo-1575176647987-4c1a2e598950?w=900", desc: "Recessed impressions for understated luxury." },
  { name: "Soft Touch Lamination", img: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=900", desc: "Velvet-like film with a calm, premium hand-feel." },
  { name: "Matte Lamination", img: "https://images.unsplash.com/photo-1607344645866-009c320b63e0?w=900", desc: "Low-glare polish that elevates print color depth." },
  { name: "Gloss Lamination", img: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=900", desc: "Mirror-grade shine that pops vivid brand color." },
  { name: "Texture Finish", img: "https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=900", desc: "Linen, leather and canvas-textured laminations." },
  { name: "Velvet Finish", img: "https://images.unsplash.com/photo-1513885535751-8b9238bd345a?w=900", desc: "Plush flocked surface for the highest-end unboxing." },
];

export const INDUSTRY_WHY = [
  { title: "Custom Structural Design", desc: "In-house CAD studio engineers dielines, 3D mockups and physical samples tailored to your SKU." },
  { title: "Premium Printing", desc: "5-color UV offset with Pantone matching, hybrid digital and HP Indigo for short runs." },
  { title: "In-house Manufacturing", desc: "Press, die-cut, foil, lamination, gluing and rigid assembly — all under one 85,000 sq.ft. roof." },
  { title: "Low MOQ", desc: "Pilot from 100 units for rigid, 500 for monocartons. Scale to millions without changing partners." },
  { title: "Fast Turnaround", desc: "Standard orders shipped in 10–15 working days. Express production on capacity." },
  { title: "Luxury Finishing", desc: "Foil, emboss, deboss, spot UV, soft-touch, velvet and custom textures crafted to a luxury standard." },
];
